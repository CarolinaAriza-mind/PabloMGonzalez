    ...
    <section id="pilares" className="py-16 md:py-24 bg-background-dark">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12 md:mb-20">
          ...
          <h2
            className="text-3xl md:text-4xl lg:text-6xl font-black text-white uppercase tracking-tight leading-none mb-6 md:mb-8"
          ...
          <p className="text-slate-400 text-sm md:text-base lg:text-lg leading-relaxed font-light max-w-xl mx-auto px-2 md:px-0">
          ...
          {pillars.map((pillar) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 p-5 md:p-8 z-20">
                <span
                  className="text-3xl md:text-5xl font-light mb-2 md:mb-4 block transition-colors duration-300 text-white/20 group-hover:text-[#C9A84C]"
                  style={{ fontFamily: "'Libre Baskerville', Georgia, serif" }}
                >
                  {pillar.number}
                </span>
                ...
                <div className="w-6 md:w-8 h-px bg-[#C9A84C] mb-2 md:mb-3 scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
                <p className="text-slate-300 text-xs md:text-sm leading-relaxed opacity-0 group-hover:opacity-100
        ...
        {/* Puente narrativo */}
        <div className="mt-16 md:mt-24 text-center max-w-2xl mx-auto px-4 md:px-0">
          <p
            className="text-lg md:text-2xl md:text-3xl text-slate-300 font-light leading-relaxed italic"
            style={{ fontFamily: "'Libre Baskerville', Georgia, serif" }}
          >
            {bridgeQuote}
          </p>
          <div className="w-12 h-px bg-[#C9A84C] mx-auto mt-6 md:mt-8 opacity-60" />
        </div>
